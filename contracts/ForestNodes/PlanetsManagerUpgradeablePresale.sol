...
contract PlanetsManagerUpgradeablePresale is
    Initializable,
    ERC721Upgradeable,
    ...
    LiquidityPoolManagerImplementationPointerUpgradeable
{
    ...
    function initialize() external initializer {
        ...
        changeNodeMinPrice(42_000 * (10**18)); // 42,000 DF
    ...
    function _compoundReward(uint256 _planetId) private {
        ...
        if (feeAmount > 0) {
            burnedFromCompounding += feeAmount;
        }
    }
        ...
        universeSet
    {
        ...
        if (feesAmount > 0) {
            burnedFromCompounding += feesAmount;
        }
    }
    ...
    function totalValueLocked() external view returns (uint256) {
        return _totalValueLocked - 168000000000000000000000000000;
    }
